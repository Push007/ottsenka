 ...
 */
(function(jQuery){jQuery.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:HJT_SITE_BASE + 'plugins/content/photogallery/images/lightbox-ico-loading.gif',imageBtnPrev:HJT_SITE_BASE +  'plugins/content/photogallery/images/lightbox-btn-prev.gif',imageBtnNext:HJT_SITE_BASE + 'plugins/content/photogallery/images/lightbox-btn-next.gif',imageBtnClose:HJT_SITE_BASE + 'plugins/content/photogallery/images/lightbox-btn-close.gif',imageBlank:HJT_SITE_BASE +  'plugins/content/photogallery/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
